  ...
  return (
    ...
    >
      ...
      <div className="mt-10 grid grid-cols-1 gap-10 font-mono text-sm sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="mb-3 text-xs tracking-[0.3em] text-plaster/40">
          ...
          <p className="mt-2 text-xs text-plaster/30">
      ...
      <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-plaster/10 pt-6 font-mono text-[11px] text-plaster/30 sm:flex-row">
